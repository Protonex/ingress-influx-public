...
void MapGraphicsView::centerOn(double longitude, double latitude)
{
...
QPointF MapGraphicsView::mapToScene(const QPoint viewPos) const
{
    ...
    QPoint vCPos=_childView->mapFrom(this,viewPos);
    //qDebug() << viewPos << vCPos;
    //QPoint vChildPos=_childView->pos();
    //qDebug() << vChildPos;

    QPointF qgsScenePos = _childView->mapToScene(vCPos);
